  ...
  module TUI
    ...
    module DashboardLayout
      ...
      def compute(area : CryTUI::Rect) : LayoutAreas
        ...
        upper = CryTUI::Layout.new(constraints: [CryTUI::Constraint.percentage(50), CryTUI::Constraint.percentage(50)], spacing: -1).split(middle_rows[0])
        lower = CryTUI::Layout.new(constraints: [CryTUI::Constraint.percentage(50), CryTUI::Constraint.percentage(50)], spacing: -1).split(middle_rows[1])
